...
REM Suppress STM32WB25xx and STM32WB20xx  Devices as not used for the mioment.
REM STM32WB25xx and STM32WB20xx corresponding to old devices STM32WB35xx and STM32WB30xx abandonned on W25 (2020)
